...
const Tapas = () => {
    return (
        <div className='bg-blue'>
            ...
            <Link to="/contact" className='block sm:hidden px-16 py-3 mt-2 text-2xl font-bold rounded-full bg-dark text-white transition duration-300 mx-[6.5vw] text-center'>JE RESERVE DE SUITE</Link>
