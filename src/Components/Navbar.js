...
const Navbar = () => {
    return (
        <div className='flex py-10 text-white h-1/6 bg-dark'>
            ...
            <button data-collapse-toggle="navbar-default" type="button" className="ml-auto mr-5 inline-flex items-center p-2 text-sm text-gray-500 rounded-lg lg:hidden" aria-controls="navbar-default" aria-expanded="false">
            ...
            <div className="hidden lg:flex ml-auto mr-5" id="navbar-default">
                <ul className="flex flex-col p-4 mt-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 lg:text-sm text-xs">
                    <li>
                        <Link to="/contact" className='px-8 font-bold border-2 border-blue rounded-full bg-dark text-white hover:bg-blue transition duration-500'>RESERVER</Link>
                    </li>
                    <li>
